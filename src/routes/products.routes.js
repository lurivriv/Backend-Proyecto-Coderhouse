...
router.post("/", noSessionMiddleware, checkRoleMiddleware(["admin", "premium"]), uploadProducts.single("thumbnail"), ProductsController.addProduct)

// Actualizar un producto (PUT: http://localhost:8080/api/products/pid)
router.put("/:pid", noSessionMiddleware, checkRoleMiddleware(["admin", "premium"]), uploadProducts.single("thumbnail"), ProductsController.updateProduct)
